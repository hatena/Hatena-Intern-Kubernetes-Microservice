...
import (
	...
	"github.com/hatena/Hatena-Intern-2022/services/blog/app"
	"github.com/hatena/Hatena-Intern-2022/services/blog/config"
	"github.com/hatena/Hatena-Intern-2022/services/blog/db"
	"github.com/hatena/Hatena-Intern-2022/services/blog/log"
	...
	"github.com/hatena/Hatena-Intern-2022/services/blog/web"
	"go.uber.org/zap"
...
func run(args []string) error {
	...
	// アカウントサービスに接続
	accountConn, err := grpc.Dial(conf.AccountAddr, grpc.WithTransportCredentials(insecure.NewCredentials()), grpc.WithBlock())
	if err != nil {
	...
	// レンダラ (記法変換) サービスに接続
	rendererConn, err := grpc.Dial(conf.RendererAddr, grpc.WithTransportCredentials(insecure.NewCredentials()), grpc.WithBlock())
	if err != nil {
