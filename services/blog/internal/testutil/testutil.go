...
import (
	...
	"github.com/hatena/Hatena-Intern-2021/services/blog/db"
	"github.com/hatena/Hatena-Intern-2021/services/blog/domain"
	pb_account "github.com/hatena/Hatena-Intern-2021/services/blog/pb/account"
	pb_renderer "github.com/hatena/Hatena-Intern-2021/services/blog/pb/renderer"
...
// AnotherECDSPrivateKey は AccountECDSPrivateKey とはまた異なるキーペアの秘密鍵
var AnotherECDSAPrivateKey = readECDSAPrivateKey(`
-----BEGIN EC PRIVATE KEY-----
MHcCAQEEIEUFeuKZhyP+b4uPtQWnlZA1mlRoy28zHK4Ed2gv7zdIoAoGCCqGSM49
AwEHoUQDQgAElZdt0m1KDS2kraUQbdmruS/CL5DQNL4aTN7AxL+6yMwc5Y1GM6Ae
GZHcN9UUDWNGXuSg67akVOOmJ4EIW7l1XQ==
-----END EC PRIVATE KEY-----
`)

// AnotherECDSPublicKey は AccountECDSPublicKey とはまた異なるキーペアの公開鍵
var AnotherECDSAPublicKey = readECDSAPublicKey(`
-----BEGIN PUBLIC KEY-----
MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAElZdt0m1KDS2kraUQbdmruS/CL5DQ
NL4aTN7AxL+6yMwc5Y1GM6AeGZHcN9UUDWNGXuSg67akVOOmJ4EIW7l1XQ==
-----END PUBLIC KEY-----
`)
...
func generateToken(id, name string) ([]byte, error) {
	claims := jwt.New()
	now := time.Now()
	iss := "hatena-intern-2021-account"
