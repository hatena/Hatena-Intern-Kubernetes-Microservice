...
import (
	...
	"github.com/hatena/Hatena-Intern-2021/services/blog/repository"
...
func verifyToken(src string, publicKey *ecdsa.PublicKey) (*userStub, error) {
	token, err := jwt.ParseString(src, jwt.WithVerify(jwa.ES256, publicKey))
	if err != nil {
		return nil, err
	}
	err = jwt.Validate(
		token,
		jwt.WithIssuer("hatena-intern-2021-account"),
