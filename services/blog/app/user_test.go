...
import (
	...
	"github.com/hatena/Hatena-Intern-2022/services/blog/internal/testutil"
...
func Test_VerifyToken(t *testing.T) {
	token, _ := generateToken("12345", "someName", "hatena-intern-2022-account", "user", testutil.AccountECDSAPrivateKey)
...
func Test_VerifyToken_WrongKey(t *testing.T) {
	token, _ := generateToken("12345", "someName", "hatena-intern-2022-account", "user", testutil.AnotherECDSAPrivateKey)
...
func Test_VerifyToken_WrongSubject(t *testing.T) {
	token, _ := generateToken("12345", "someName", "hatena-intern-2022-account", "wrongUser", testutil.AccountECDSAPrivateKey)
