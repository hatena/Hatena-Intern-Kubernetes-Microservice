...
import (
	...
	"github.com/hatena/Hatena-Intern-2021/services/account/grpc"
	"github.com/hatena/Hatena-Intern-2021/services/account/internal/testutil"
...
func verifyToken(src string) (jwt.Token, error) {
	token, err := jwt.ParseString(src, jwt.WithVerify(jwa.ES256, ecdsaPublicKey))
	if err != nil {
		return nil, err
	}
	return token, nil
