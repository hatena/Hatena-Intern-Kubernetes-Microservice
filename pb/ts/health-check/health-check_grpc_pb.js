...
var health$check_pb = require('./health-check_pb.js');

function serialize_grpc_health_v1_HealthCheckRequest(arg) {
  if (!(arg instanceof health$check_pb.HealthCheckRequest)) {
...
function deserialize_grpc_health_v1_HealthCheckRequest(buffer_arg) {
  return health$check_pb.HealthCheckRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_grpc_health_v1_HealthCheckResponse(arg) {
  if (!(arg instanceof health$check_pb.HealthCheckResponse)) {
...
function deserialize_grpc_health_v1_HealthCheckResponse(buffer_arg) {
  return health$check_pb.HealthCheckResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var HealthService = exports.HealthService = {
  check: {
    ...
    requestType: health$check_pb.HealthCheckRequest,
    responseType: health$check_pb.HealthCheckResponse,
